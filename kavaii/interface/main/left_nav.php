 ...
 */
 ...
 $primary_docs = array(
  ...
  'dem' => array(xl('Patient')   , 1,  "patient_file/summary/demographics.php"),
   'op' => array(xl('OPD CARD')   , 0,  "patient_file/opprint.php"),
  ...
  'dis' => array(xl('Discharge') , 0, 'forms/Bed_Summary/new.php'),
...
$(document).ready(function(){
  if(3 == <?php echo $GLOBALS['concurrent_layout'] ?>){
	...
	$("#navigation-slide > li  > a#certificateimg").prepend('<img src="../../images/certificate-border.png" class="nav-menu-img" />');
	...
	$("#navigation-slide > li  > a#voucherimg").prepend('<img src="../../images/vouchers.png" class="nav-menu-img" />');
...
?>
  ...
  <li class="open"><a class="collapsed" id="repimg" ><span><?php xl('Reports','e') ?></span></a>
    <ul>
      ...
      <li><a class="collapsed_lv2"><span><?php xl('Patient','e') ?></span></a>
        <ul>
  ...
  <li><a class="collapsed" id="feeimg" ><span><?php xl('Fees','e') ?></span></a>
    <ul>
      ...
      <?php genMiscLink('RBot','bil','1',xl('Discount'),'patient_file/pos_checkout.php?framed=1'); ?>
	  <?php // genMiscLink('RBot','voc','1',xl('Payment Voucher'),'encounters_report.php?framed=1'); ?>
    </ul>
  </li> 
  <?php } ?>
...
<?php } else { // not athletic team ?>
  ...
  <li class="open"><a class="expanded" id="patimg" ><span><?php xl('Patient','e') ?></span></a>
    <ul>
...
<?php } // end if gbl_nav_visit_forms ?>
  ...
  <li class="open"><a class="expanded" id="bedimg" ><span><?php xl('Bed Management','e') ?></span></a>
    <ul>
      <?php genTreeLink('RTop','dis',xl('Bed Management Form'));  ?>
	  </ul>
	  </li>
	     <li class="open"><a class="expanded" id="certificateimg" ><span><?php xl('Certificates','e') ?></span></a>
    <ul>
	 ...
	 <?php genMiscLink('RTop','rop','2',xl('Dealth Certificate'), 'reports/dealth_certificate.php'); ?>
	  ...
	  <?php
		...
		if($id['id']==94||$id['id']==1) { ?>
		<li class="open"><a class="expanded" ><span><?php xl('Managing','e') ?></span></a>
        <ul>
  ...
  <li><a class="collapsed" id="feeimg" ><span><?php xl('Fees','e') ?></span></a>
    <ul>
	  ...
	  <?php $newcrop_user_role=sqlQuery("select federaldrugid from users where username='".$_SESSION['authUser']."'");
	  $newcrop_user_role=sqlFetchArray($newcrop_user_role);
	  if ($newcrop_user_role['federaldrugid']!=null) { ?>
  ...
  <li><a class="collapsed" id="voucherimg" ><span><?php xl('Vouchers','e') ?></span></a>
    <ul>
	<?php genMiscLink('RBot','voc','0',xl('Payment Voucher'),'reports/payment_voucher.php?framed=1'); ?> 
	  ...
	  <?php genMiscLink('RTop','voc','0',xl('Bank Voucher'),'reports/Bank_Voucher.php?framed=1'); ?>	
	  <?php genMiscLink('RTop','voc','0',xl('Withdrawal Voucher'),'reports/Withdrawal_Voucher.php?framed=1'); ?>
	  <?php genMiscLink('RTop','voc','0',xl('Receivables Voucher'),'reports/Receivables_Vouchers.php?framed=1'); ?>
	   <?php } ?>	  
	  </ul>
	  </li>
  <?php } ?>
    ...
    <ul>
      ...
      <li><a class="collapsed_lv2"><span><?php xl('Visits','e') ?></span></a>
        <ul>
		  ...
		  <?php if (!$GLOBALS['disable_calendar']) genMiscLink('RTop','rep','0',xl('OP Doctors'),'reports/op_cons_doc_wise.php'); ?>
...
<?php if (acl_check('acct', 'rep_a')) { ?>
      <li><a class="collapsed_lv2"><span><?php xl('Financial','e') ?></span></a>
        <ul>
		  ...
		  <?php genMiscLink('RTop','rep','0',xl('Sales By Service Groups'),'reports/sales_by_services.php'); ?>
          ...
          <?php genMiscLink('RTop','rep','0',xl('Front Rec'), 'reports/front_receipts_report.php'); ?>
		   ...
		   <?php genMiscLink('RTop','rep','0',xl('Bank Rec'), 'reports/Banks_Voucher.php'); ?>
		   <?php genMiscLink('RTop','rep','0',xl('Withdrawal Rec'), 'reports/Withdrawal_Records.php'); ?>
		   <?php genMiscLink('RTop','rep','0',xl('Receivables Rec'), 'reports/Receivables_Records.php'); ?>
...
<?php if (! $GLOBALS['simplified_demographics']) { ?>
      <li><a class="collapsed_lv2"><span><?php xl('Insurance','e') ?></span></a>
        <ul>
		  ...
		  <?php genMiscLink('RTop','rep','0',xl('Ins Process Delays'),'reports/insurance_delays.php'); ?>

		  <?php genMiscLink('RTop','rep','0',xl('Ins Report'),'reports/insurance_allocation_report1.php'); ?>
