...
if ($mode == 'new')
{
  ...
  addForm($encounter, "New Patient Encounter",
    ...
    $row1=sqlStatement("Select code,code_type,code_text,pr_price,username from codes a,prices b, users c where a.id=b.pr_id and a.code=c.username and b.pr_level='standard'and  c.id='".$provider_id."'");
	...
	{
    $inc1=sqlStatement("Select code,code_type,code_text,pr_price,username from codes a,prices b, users c where a.id=b.pr_id and a.code=c.username and b.pr_level='HosInsurance' and  c.id='".$provider_id."'");
	...
	if($pc_catid==13)
		 {
			$ct="CASUALTY CONSULTATION (DAY)"; 	 
		    $cas1=sqlStatement("Select code,code_type,code_text,pr_price from codes a,prices b where a.id=b.pr_id and a.code='".$ct."' and a.code_type=6 and b.pr_level='standard'");
		 ...
		 {
			$ct1="CASUALTY CONSULTATION (NIGHT)";
		    $cas3=sqlStatement("Select code,code_type,code_text,pr_price from codes a,prices b where a.id=b.pr_id and a.code='".$ct1."' and a.code_type=6 and b.pr_level='standard'");
