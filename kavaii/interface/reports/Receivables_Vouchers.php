...
<title><?php echo xlt('Receivables Voucher') ?></title>
</head>
<body leftmargin='0' topmargin='0' marginwidth='0' marginheight='0' class="body_top">


<form method='post' action='Receivables_Vouchers.php' id='theform'>
...
$rse=$rs['username'];
	...
	$payout=$_POST['amt'];
	 ...
	 $r2=sqlInsert("INSERT into vouchers_receivables SET ".
	  "posted_date= NOW(), " .
	...
	"reference_no = '" . add_escape_custom($check_no) . "', " .
	  ...
	  $voucher_no="SELECT voucher_no from vouchers_receivables order by voucher_no desc limit 1";
	  $voucher=sqlStatement($voucher_no);
	  $voch=sqlFetchArray($voucher);
	  $voc=$voch['voucher_no'];
	echo "<center><h4>".xlt("Receivables Voucher")."</h4></center>";
	?>  
<div id="report">
