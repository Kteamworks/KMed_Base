...
$rse=$rs['username'];
 	...
 	$qry="UPDATE billing set voucherpaid_YN='1'  where code='".$rse."'and billed='1' and code_type='Doctor Charges' AND " ."date >=  ? AND date <= ?";
...
//sqlQuery('insert into billing where ');
        ...
        "FROM form_encounter as fe ".
        "JOIN billing as b on b.pid=fe.pid and b.encounter=fe.encounter ".
		"WHERE b.code_type != 'COPAY' AND b.code='".$rse."'and b.billed='1' and b.code_type='Doctor Charges' AND b.activity = 1 AND b.voucherpaid_YN!=1 AND b.fee != 0  AND ".
        "b.date >=  ? AND b.date <= ? ";
