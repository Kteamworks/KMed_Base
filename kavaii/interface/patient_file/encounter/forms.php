            ...
            if ( $formdir  == 'admit') {
			 ...
			 if(!($result['status']=='discharge'|| $result['status']=='left'))
			 {
                ...
                echo "<a target='".
                    ...
                    "&encounter=". $encounter.
                    "&pid=".$pid.
                    "' class='css_button_small' title='" . xl('Discharge this Patient') . "' onclick='top.restoreSession()'><span>" . xl('Discharge') . "</span></a>";
            }
			else
			{?><a href='javascript:;' class='css_button_small' style='color:gray'><span><?php xl('Discharge','e'); ?></span></a><?php
			}
			} else {
                ?><?php
            }
            ...
            if ( $formdir  == 'admit') {
			 ...
			 if(!($result['status']=='discharge'|| $result['status']=='left'))
			 {
                ...
                echo "<a target='".
                    ...
                    "&encounter=". $encounter.
                    "&pid=".$pid.
                    "' class='css_button_small' title='" . xl('Transfer this Patient') . "' onclick='top.restoreSession()'><span>" . xl('Transfer') . "</span></a>";
            }
			else
			{?><a href='javascript:;' class='css_button_small' style='color:gray'><span><?php xl('Transfer','e'); ?></span></a><?php
			}
			} else {
                ?><?php
            }
         if ( $formdir  == 'admit') {
			 ...
			 if(!($result['status']=='left'))
			 {
                ...
                echo "<a target='".
                    ...
                    "&encounter=". $encounter.
                    "&pid=".$pid.
                    "' class='css_button_small' title='" . xl('Edit') . "' onclick='top.restoreSession()'><span>" . xl('Edit') . "</span></a>";
            }else
			 {
			...
			{?><a href='javascript:;' class='css_button_small' style='color:gray'><span><?php xl('Edit','e'); ?></span></a><?php
			}
			} else {
                ?><?php
            }
