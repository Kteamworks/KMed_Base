...
<span class='title'><?php xl('Report','e'); ?> - <?php xl('Withdrawal Voucher Receipts','e'); ?></span>
...
if ($usr=='all')
{
  ...
  $query = "SELECT id, voucher_no,posted_date,amount,head,auth_user, description, pay_to FROM vouchers_withdrawal WHERE " .
