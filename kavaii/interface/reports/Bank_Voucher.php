...
<title><?php echo xlt('Bank Voucher') ?></title>
</head>
<body leftmargin='0' topmargin='0' marginwidth='0' marginheight='0' class="body_top">


<form method='post' action='Bank_Voucher.php' id='theform'>
...
$rse=$rs['username'];
	...
	$payout=$_POST['amt'];
	 ...
	 $r2=sqlInsert("INSERT into vouchers_bank SET ".
	  "posted_date= NOW(), " .
	...
	"bank = '" . add_escape_custom($_POST['Banks']) . "', " .
	  ...
	  $voucher_no="SELECT voucher_no from vouchers_bank order by voucher_no desc limit 1";
	  $voucher=sqlStatement($voucher_no);
	  $voch=sqlFetchArray($voucher);
	  $voc=$voch['voucher_no'];
	echo "<center><h4>".xlt("Bank Voucher")."</h4></center>";
	?>  
<div id="report">
...
<input type='hidden' name='Banks' id='Banks' value='<?php echo $_POST['Banks']?>'></input>
