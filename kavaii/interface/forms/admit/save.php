...
diagnosis                   = '" . add_escape_custom($_POST["diagnosis"]) ."'";
  ...
  if (empty($id)) {
   ...
   if($rate=="TPAInsurance")
	{
	$row1=sqlStatement("SELECT a.code,a.code_text,b.pr_price from codes a,prices b  where a.id=b.pr_id and a.code_type='".$codetype."' and b.pr_level='Insurance' and a.code like '".$admit_to_ward."%' and b.pr_price!=0");
    ...
    $row1=sqlStatement("SELECT a.code,a.code_text,b.pr_price from codes a,prices b  where a.id=b.pr_id and a.code_type='".$codetype."' and b.pr_level='standard' and a.code like '".$admit_to_ward."%' and b.pr_price!=0");
