        ...
        if (count($patient) > 0) {
            ...
            //foreach ($patient as $be) {
				...
				foreach ($billing as $b)				
				{
					...
					$rate=$b['fee']/$b['units'];
					if($b['code_text']!='INSURANCE DIFFERENCE AMOUNT' & $b['code_text']!='INSURANCE CO PAYMENT' & $b['code_text']!='REGISTRATION CHARGES'){
                    echo "<tr>";
...
//		   echo "<tr style='border-top: 1px solid #000;'><td colspan=6>&nbsp; </td></tr>";
	//	   echo "<tr style='border-bottom: 1px solid #000;'><td colspan=6>&nbsp; </td></tr>";
			...
			echo "<tr style='border-bottom: 1px solid #000;'><td class='bold' colspan=5 style='text-align:right'>".xlt('Primary Sponsor Amount:')."&nbsp&nbsp"."</td><td class='text' align='right'>" . oeFormatMoney($approved_amt) . "</td></tr>";
			
			
			echo "<tr style='border-bottom: 1px solid #000;'><td class='bold' colspan=5 style='text-align:right'>".xlt('Pri Sponsor Due:')."&nbsp&nbsp"."</td><td class='text' align='right'>" . oeFormatMoney($ins_due) . "</td></tr>";
