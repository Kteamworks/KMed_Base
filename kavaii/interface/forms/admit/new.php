...
?>
	...
	<tr>
	<td><img src="bed.png" height='42', width='40',name="nothing" readonly></img></td>
	<td> <a href='emptybeds.php'>Find Beds</a> </td></tr>
	<tr>
   ...
   ?>
		...
		<td colspan="3"><textarea name="diagnosis" rows="3" cols="60" wrap="virtual name"><?php echo attr($diagnosis);?></textarea></td>
			</tr>
			<tr>
		<td align="left colspan="3" style="padding-bottom:7px;"></td>
	</tr>
