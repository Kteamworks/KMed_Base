...
function image_widget($doc_id,$doc_catg)
{
        ...
        if ( in_array($extension,$viewable_types) ) { // extention matches list
                $to_url = "
				<tr><td align='left'style='font-size: 12px;'><b><FONT COLOR='#ffffff'>".htmlspecialchars($id)."</font></b></td></tr>".
				"<tr><td rowspan=3 align='right'><a href = $web_root" .
                ...
                " <img src = $web_root" .
				"/controller.php?document&retrieve&patient_id=$pid&document_id=$doc_id" .
				" width=85 height=54 alt='$doc_catg:$image_file'>  </a> </td></tr>
				<tr></tr>
				<tr></tr>
				<tr><td valign='center' style='font-size: 12px;'> <b><FONT COLOR='#ffffff'>".
                ''.'<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.htmlspecialchars('Name:'.$name) . '<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . htmlspecialchars("Blood Group: ".$bgrp) . '<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . htmlspecialchars("DOB:".$db1) .'<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . htmlspecialchars("Valid Upto:".$end) .'<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . htmlspecialchars("Address:".$addr) .
				"</b></font></td></tr>";
        }
     	else {
...
<div>
    ...
    if ($photos or $idcard_doc_id )
    {
		...
		$widgetButtonLabel = xl("Print");
        $widgetLabel = "photos";
        $linkMethod = "javascript";
        $bodyClass = "notab-right";
		$widgetButtonLink = "return printid()";
	    $widgetButtonClass = "";
        $widgetAuth = true;
        $fixedWidth = false;
        expand_collapse_widget($widgetTitle, $widgetLabel, $widgetButtonLabel ,
