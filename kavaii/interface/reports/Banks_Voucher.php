...
<span class='title'><?php xl('Report','e'); ?> - <?php xl('Bank Voucher Receipts','e'); ?></span>

<div id="report_parameters_daterange">
<?php echo date("d F Y", strtotime($form_from_date)) ." &nbsp; to &nbsp; ". date("d F Y", strtotime($form_to_date)); ?>
</div>

<form name='theform' method='post' action='Banks_Voucher.php' id='theform'>
...
if ($usr=='all')
{
  ...
  $query = "SELECT id, voucher_no,posted_date,amount,head,auth_user, description, pay_to FROM vouchers_bank WHERE " .
